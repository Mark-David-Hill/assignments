...
def equalize_lengths(x, y):
  ...
  # zfill(length) pads with 0's by default. string method
...
def bin_add(n1, n2):
  ...
  carry = '0'
  # Unpacking Syntax
  (n1, n2, max_length) = equalize_lengths(n1, n2)
...
def bin_sub(n1, n2):
  ...
  for i in range(max_length - 1, -1, -1):
    if n1[i] == n2[i]:
      r1 = borrow
      borrow = '0' if n1 == '0' else borrow
    elif n1[i] > n2[i]:
      r1 = '1' if borrow == '0' else '0'
    elif n1[i] < n2[i]:
      r1 = '1' if borrow == '0' else '0'
      borrow = r1
    result = r1 + result
...
def bin_mult(n1, n2):
  ...
  result = '0'
  while not is_zero(n1):
    result = bin_add(n2, result)
    n1 = bin_sub(n1, '1')
...
def bin_div(n1, n2):
  ...
  count = '0'
  while not is_zero(n1):
    count = bin_add(count, '1')
    n1 = bin_sub(n1, n2)
    
  return count

# print(bin_add('101', '010'))
# print(bin_sub('10111110', '100110'))
print(bin_div('1000', '0010'))
